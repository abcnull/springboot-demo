...
/**
 * 【通用流程简单解释：】
 * 客户端 (SEI) -> 多媒体服 (调业务 HTTP/rpc 接口) -> 业务 HTTP/rpc 接口承接 (CMD 命令) -> 客户端
 * <p>
 * 【SEI 流程解释：】
 * 客户端 >------------- SEI 信息 --------------> 多媒体服务
 * ************************************************ V
 * ************************************************ ｜
 * ************************************************ ｜
 * ********************************* 处理后的数据，调业务 http/rpc 接口来发送数据
 * ************************************************ ｜
 * ************************************************ ｜
 * ************************************************ V
 * ******************************* 业务服务端的 HTTP/rpc 接口（当前 controller）
 * <p>
 * 【CMD 流程解释：】
 * 多媒体服务 <-- http/rpc 连接 --> 业务服务端的 HTTP/rpc 接口（当前 controller）--------
 * ************************************************************************* V
 * ************************************************************************* ｜
 ...
 * 多媒体服务会对 SEI 数据进行处理后，调用业务服务端（这里）的 http/rpc 接口，将关键数据传过来
